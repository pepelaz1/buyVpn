...
#define VC_CURRENT_VERSION				TEXT("2.00")
...
#define VC_BALANCE_BEGIN				"<dd class='ballance'><span class='currency'>$</span> <strong class='green'>"
#define VC_BALANCE_END					"</strong></dd>"
